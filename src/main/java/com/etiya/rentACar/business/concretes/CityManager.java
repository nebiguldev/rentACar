...
public class CityManager implements CityService {
    ...
    public DataResult<List<ListCityDto>> getAll(){
        ...
        List<ListCityDto> responce=result.stream().map(city -> modelMapperService.forDto().map(city,ListCityDto.class)).collect(Collectors.toList());
        return new SuccessDataResult<List<ListCityDto>>(responce);
    }
